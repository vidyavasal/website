...
const statCards = [
  { label: "Universities", key: "universities" as const, icon: "🏫", href: "/admin/universities", color: "bg-blue-50 text-blue-700" },
  { label: "Courses", key: "courses" as const, icon: "📚", href: "/admin/courses", color: "bg-purple-50 text-purple-700" },
  { label: "Categories", key: "categories" as const, icon: "🗂️", href: "/admin/courses", color: "bg-green-50 text-green-700" },
  { label: "Fee Records", key: "feeRecords" as const, icon: "💰", href: "/admin/courses", color: "bg-orange-50 text-orange-700" },
];
    ...
    <div className="max-w-5xl">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link href="/universities" target="_blank" className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
            ↗ View Universities Page
          </Link>
          <Link href="/courses" target="_blank" className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition-colors">
            ↗ View Courses Page
          </Link>
        </div>
      </div>
