      ...
      <section className="relative overflow-hidden hero-mesh-bg pt-12 pb-16 md:pt-20 md:pb-24">
        ...
        <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <a href="https://wa.me/910000000000" target="_blank" rel="noopener noreferrer" className="px-8 py-4 rounded-full bg-white border border-[#E5E5EA] text-[#1D1D1F] font-bold text-base hover:bg-[#E8FAF0] transition-all flex items-center justify-center gap-2">
